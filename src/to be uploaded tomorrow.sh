...
#$ -N batch_pangenie_singlefq_switzerland_16_samples
#$ -cwd
#$ -l h_vmem=16G
#$ -l h_rt=120:00:00
#$ -pe sharedmem 6
...
SAMPLE_LIST="$BASE/samples/sample_ids_16.txt"
TMP_DIR="$BASE/tmp/${JOB_ID}_${SGE_TASK_ID}"
RESULT_DIR="$BASE/results_switzerland_16"
...
FASTQC_DIR="$RESULT_DIR/fastqc/$SAMPLE_NAME"
